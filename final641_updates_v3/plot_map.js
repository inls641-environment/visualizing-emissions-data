...
class USA_MAP {
    ...
    async render(_subset) {
        //determine what is the energy source of interest
        //code help from: https://stackoverflow.com/questions/1085801/get-selected-value-in-dropdown-list-using-javascript
        ...
        this.svg.selectAll(".city").data(cities, d=> d).join(
            enter => enter.append('circle')
                ...
                .on("click", (event,d) => {
                    ...
                    var city_histo = new city_histogram("histo_disto", emissions, d[1][0]['ID']);
                })
                .raise(),
