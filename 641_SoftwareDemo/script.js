        ...
        this.svg.selectAll(".city").data(cities, d=> d).join(
            ...
            enter => enter.append('circle')
                ...
                .on("mouseover", (event, d) => {
                    document.getElementById("infobox").innerHTML = "The " + d[1][0]['City'] + " gets " + Math.round(d[1][0]['Reneweable'] * 100) + "% of their energy from renewable sources.";
                })
                .on("mouseout", (event, d) => {
                    document.getElementById("details").innerHTML = ""})
                .on('onclick', (event, d) => {
                    document.getElementById("infobox").innerHTML = "fjkdsklj    "
                })
                .raise(),
